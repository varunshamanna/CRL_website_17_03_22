...
if(isset($_POST['url']) && $_POST['url'] == '' && $_POST['message'] != ''){
	...
	$body = "Central Research - Contact us form that was just submitted:
	Name:  $_POST[name]
	Phone: $_POST[phone]
	E-Mail: $_POST[email]
	...
	mail($youremail, 'Central Research - Contact us Form', $body, $headers );
	//echo "message sent";
...
exit('Redirecting you to https://dlwhosting.com/demo/centralresearch/contact.html');
